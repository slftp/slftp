...
const
  ...
  ircCommandsArray: array[1..228] of TIrcCommand = (
    ...
    (cmd: 'taskstats'; hnd: IrcTaskStats; minparams: 0; maxparams: 1; hlpgrp: 'info'),
    (cmd: 'taskdump'; hnd: IrcTaskDump; minparams: 0; maxparams: 1; hlpgrp: 'info'),
    (cmd: 'dirlistgaps'; hnd: IrcDirlistGaps; minparams: 1; maxparams: 1; hlpgrp: 'info'),
