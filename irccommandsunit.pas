...
const
  ...
  ircCommandsArray: array[1..226] of TIrcCommand = (
    ...
    (cmd: 'lockstats'; hnd: IrcLockStats; minparams: 0; maxparams: 0; hlpgrp: 'misc'),
    ...
    (cmd: 'pretimestats'; hnd: IrcPretimeStats; minparams: 0; maxparams: 0; hlpgrp: 'pretime'),
