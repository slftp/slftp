...
set CINCLUDES=-Ulibs/FastMM4 -Ulibs/BeRoHighResolutionTimer -Ulibs/FLRE -Ulibs/rcmdline -Ulibs/DFFLibV15_UIntList -Ulibs/lkJSON -Ulibs/TRegExpr -Ulibs/pasmp -Ulibs/Compvers -Ulibs/ctypes -Ulibs/Indy10_5457/Core -Ulibs/Indy10_5457/Protocols -Ulibs/Indy10_5457/System -Ulibs/LibTar
