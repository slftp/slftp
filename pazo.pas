...
begin
  ...
  begin
    ...
    begin
      ...
      if fsize < 0 then
      begin
        irc_Addstats(Format('<c4>[NEGATIVE BYTES]</c> : %e for %s with SizeRacedByMe(true) = %e, /1024 : %e, dirname : %s', [fsize, fsname, dirlist.SizeRacedByMe(True), dirlist.SizeRacedByMe(True) / 1024, dirlist.Dirname]));
