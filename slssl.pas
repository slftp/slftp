...
begin
  ...
  gSSLContextSettings := SSL_CTX_new(TLS_client_method());
    ...
    // Eliminates full handshake (3-5 RTTs) on repeated connections
    // Cache: 2048 sessions (100 sites × 10 slots × 2 overhead)
    ...
    SSL_CTX_set_timeout(gSSLContextSettings, 300); // 5 minutes
    ...
    // Prioritize AES-GCM cipher suites for AES-NI hardware acceleration
    ...
    // Scene FTP sites typically use self-signed certs
