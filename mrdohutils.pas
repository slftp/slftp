...
if not fileexists(s+'slftp.ini') then result:=result+'slftp.ini not found!'+#10#13;
if not fileexists(s+'imdbcountrys.nwo') then result:=result+'imdbcountrys.nwo not found!'+#10#13;
if not fileexists(s+'languagebase.slftp') then result:=result+'languagebase.slftp not found!'+#10#13;
if not fileexists(s+'slftp.knowngroups') then result:=result+'slftp.knowngroups not found!'+#10#13;
if not fileexists(s+'slftp.languages') then result:=result+'slftp.languages not found!'+#10#13;
if not fileexists(s+'slftp.precatcher') then result:=result+'slftp.precatcher not found!'+#10#13;
if not fileexists(s+'slftp.skip') then result:=result+'slftp.skip not found!'+#10#13;
if not fileexists(s+'slftp.skipgroups') then result:=result+'slftp.skipgroups not found!'+#10#13;
if not fileexists(s+'slftp.spamconf') then result:=result+'slftp.spamconf not found!'+#10#13;
end;
