...
2013-09-17  SLFTP  2.1   Bring back FPC support with fixed tarheader...
*)
...
BEGIN
  ...
  if (Pos('.gz', targetFilename) = length(targetFilename)-2) then
  begin
    fStream2:= fStream;
    fStream:= TCompressionStream.Create(clDefault, fStream2);
  end;
