...
uses
  SysUtils, Contnrs, Generics.Collections, dbhandler, debugunit, configunit, sitesunit, irc, mystrings, slcriticalsection2, DateUtils, mormot.core.unicode, mormot.core.os, mormot.db.raw.sqlite3,
          ...
          try
            ...
            begin
              ...
              if not fDoc.Exists(fGroupKey) then
                fDoc.AddValue(fGroupKey, _Obj(['size', 0, 'count', 0]));
