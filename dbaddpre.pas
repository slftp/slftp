...
begin
  ...
  fJsonMapping :=
    '{' + #13#10 +
    '  "tableName": "' + glMySQLPretimeTableName + '",' + #13#10 +
    '  "columns": {' + #13#10 +
    '    "rlz": "' + glMySQLPretimeRlsNameField + '",' + #13#10 +
    '    "ts": "' + glMySQLPretimeRlsDateField + '",' + #13#10 +
    '    "section": "' + glMySQLPretimeSectionField + '",' + #13#10 +
    '    "source": "' + glMySQLPretimeSourceField + '"' + #13#10 +
    '  }' + #13#10 +
    '}';
